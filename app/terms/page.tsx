                ...
                <div className="prose prose-invert max-w-none space-y-6">
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            {language === "zh"
                                ? `${org.name} 報帳系統（以下簡稱「本系統」）是專為企業設計的智慧費用報銷管理平台。本系統提供費用申報、審核、追蹤等功能，協助企業高效管理財務支出。`
                                : `The ${org.name} Expense System (hereinafter referred to as "the System") is a smart expense reimbursement management platform designed for enterprises. The System provides expense submission, approval, and tracking functions to help businesses efficiently manage financial expenses.`
                            }
                        </p>
                    </section>
