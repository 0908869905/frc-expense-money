      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="mt-8 text-gray-500 text-sm">
            {language === "zh" ? "企業財務管理解決方案" : "Enterprise Financial Management Solution"}
          </p>
        </div>
      </div>
            ...
            <div className="lg:hidden text-center mb-12">
              <Link href="/">
                <h1 className="text-5xl font-black tracking-tighter">
                  <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Expense</span>
                  <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Flow</span>
                </h1>
              </Link>
            </div>
